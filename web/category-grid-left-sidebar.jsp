<%-- 
    Document   : category-grid-left-sidebar
    Created on : Jan 26, 2022, 12:15:10 AM
                        ...
                        <div class="widget price-filter biolife-filter">
                            ...
                            <div class="wgt-content">
                                ...
                                <ul class="check-list bold single">
                                    <li class="check-list-item"><a href="#" class="check-link">Rs. 0 - Rs. 5</a></li>
                                    <li class="check-list-item"><a href="#" class="check-link">Rs. 5 - Rs. 10</a></li>
                                    <li class="check-list-item"><a href="#" class="check-link">Rs. 15 - Rs. 20</a></li>
                                </ul>
                            </div>
                        </div>
