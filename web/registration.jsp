<%-- 
    ...
    Created on : Jan 25, 2022, 11:30:59 PM
...
<body class="biolife-body">
    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                <li class="nav-item"><a href="index.jsp" class="permal-link">Home</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="signin-container">
                            <form action="#" name="frm-login" method="post">
                                ...
                                <p class="form-row">
                                    <label for="fid-name">National Identity No:<span class="requite">*</span></label>
                                    <input type="text" id="fid-name" name="name" value="" class="txt-input">
                                </p>
                                <p class="form-row">
                                    <label for="fid-name">Contact number:<span class="requite">*</span></label>
                                    <input type="text" id="fid-name" name="name" value="" class="txt-input">
                                </p>
                                <p class="form-row">
                                ...
                                <p class="form-row">
                                    <label for="fid-name">Home Address:<span class="requite">*</span></label>
                                    <input type="text" id="fid-name" name="name" value="" class="txt-input">
                                </p>
                                <p class="form-row">
                                ...
                                <p class="form-row">
                                    <label for="fid-pass">Re-type password:<span class="requite">*</span></label>
                                    <input type="email" id="fid-pass" name="email" value="" class="txt-input">
                                </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="register-in-container">
                            <div class="intro">
                                <h4 class="box-title">Already a customer?</h4>
                                <p class="sub-title">Then login to your account to:</p>
                                <ul class="lis">
                                ...
                                <a href="register.jsp" class="btn btn-bold">Sign in</a><br/>
                            </div>
                        </div>
                    </div>
