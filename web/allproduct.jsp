<%-- 
    Document   : allproduct
    Created on : Jan 26, 2022, 12:06:57 AM
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="index.jsp" class="biolife-logo"><img src="assets/images/organic-3.png" alt="biolife logo" width="135" height="34"></a>
                    </div>
                                    ...
                                    <form action="#" name="frm-refine" method="get">
                                        ...
                                        <div data-title="Price:" class="selector-item">
                                            <select name="price" class="selector">
                                                ...
                                                <option value="class-1st">Less than Rs. 5</option>
                                                <option value="class-2nd">Rs. 5-10</option>
                                                <option value="class-3rd">Rs. 10-20</option>
                                                <option value="class-4th">Rs. 20-45</option>
                                                <option value="class-5th">Rs. 45-100</option>
                                                <option value="class-6th">Rs. 100-150</option>
                                                <option value="class-7th">More than Rs. 150</option>
                                            </select>
                                        </div>
                            ...
                            <div class="flt-item to-right">
                                ...
                                <div class="wrap-selectors">
                                    ...
                                    <div class="selector-item viewmode-selector">
                                        <a href="category-grid-left-sidebar.jsp" class="viewmode grid-mode active"><i class="biolife-icon icon-grid"></i></a>
                                        <a href="category-list-left-sidebar.jsp" class="viewmode detail-mode"><i class="biolife-icon icon-list"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="copy-right-text"><p><a href="templateshub.net">Bhawa Boga</a></p></div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12">
        ...
        <div class="block-global-contain">
            ...
            <div class="glb-item currency">
                ...
                <ul class="list">
                    ...
                    <li class="list-item"><a href="#">Rs.  USD (Dollar)</a></li>
                    <li class="list-item"><a href="#">Rs.  GBP (Pound)</a></li>
