<%-- 
    Document   : index
    Created on : Jan 25, 2022, 5:46:35 PM
...
<head>
    ...
    <title>Bhawa Boga - Organic Food</title>
            ...
            <div class="container">
                <div class="top-bar left">
                    <ul class="horizontal-menu">
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>bhawaboga@company.com</a></li>
                        <li><a href="#">Free Shipping for all Order above Rs.  5000.00</a></li>
                    </ul>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="index.jsp" class="biolife-logo"><img src="assets/images/organic-3-green.png" alt="Bhawa boga logo" width="135" height="36"></a>
                    </div>
                            ...
                            <div class="minicart-block">
                                <div class="minicart-contain">
                                    <a href="javascript:void(0)" class="link-to">
                                        ...
                                        <span class="sub-total">Rs. 0.00</span>
                                    </a>
                ...
                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-4 col-sm-12 xs-margin-bottom-25 md-margin-bottom-0">
                                                        <div class="wrap-custom-menu vertical-menu">
                                                            ...
                                                            <ul class="menu">
                                                                <li><a href="allproduct.jsp">Fruit & Nut Gifts</a></li>
                                                                <li><a href="#">Mixed Fruits</a></li>
                                                                <li><a href="#">Oranges</a></li>
                                                                <li><a href="#">Bananas & Plantains</a></li>
                                                                <li><a href="#">Fresh Gala Apples</a></li>
                    ...
                    <div class="col-lg-9 col-md-8 padding-top-2px">
                        <div class="header-search-bar layout-01">
                            <form action="searchproduct.jsp" class="form-search" name="desktop-seacrh" method="get">
                                <input type="text" name="s" class="input-text" value="" placeholder="Search here...">
                                <select name="category">
                                    <option value="-1" selected>All Categories</option>
                                    <option value="vegetables">Vegetables</option>
                        ...
                        <div class="live-info">
                            <p class="telephone"><i class="fa fa-phone" aria-hidden="true"></i><b class="phone-number">011 234 2343</b></p>
    ...
    <div class="page-contain">
        ...
        <div id="main-content" class="main-content">
                    ...
                    <li>
                        <div class="slide-contain slider-opt03__layout02 slide_animation type_02">
                            ...
                            <div class="text-content">
                                <i class="first-line">Feel the freshness</i>
                                <h3 class="second-line">Vegetables directly from Farm gate to your doorstep</h3>
                                <p class="third-line">Because you deserve a better life</p>
                                <p class="buttons">
            ...
            <div class="special-slide">
                <div class="container">
                    <ul class="biolife-carousel dots_ring_style" data-slick='{"arrows": false, "dots": true, "slidesMargin": 30, "slidesToShow": 1, "infinite": true, "speed": 500, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 1}},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":20, "dots": false}},{"breakpoint":480, "settings":{ "slidesToShow": 1}}]}' >
                        <li>
                            <div class="slide-contain biolife-banner__special">
                                <div class="banner-contain">
                                    ...
                                    <div class="text-content">
                                        <b class="first-line">Corn</b>
                                        <span class="second-line">All fresh</span>
                                        <span class="third-line">Easy <i>Healthy, Happy Life</i></span>
                                        <div class="product-detail">
                                            <h4 class="product-name">A healthy meal for every one</h4>
                                            <div class="price price-contain">
                                                <ins><span class="price-amount"><span class="currencySymbol">Rs. </span>85.00</span></ins>
                                                <del><span class="price-amount"><span class="currencySymbol">Rs. </span>95.00</span></del>
                                            </div>
                                            <div class="buttons">
                                                <a href="productview.jsp" class="btn add-to-cart-btn"></i>add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class="slide-contain biolife-banner__special">
                                <div class="banner-contain">
                                    <div class="media">
                                        <a href="#" class="bn-link">
                                            <figure><img src="assets/images/home-03/bn_special_org1.jpg" width="616" height="483" alt=""></figure>
                                        </a>
                                    </div>
                                    <div class="text-content">
                        ...
                        <li>
                            <div class="slide-contain biolife-banner__special">
                                <div class="banner-contain">
                                    <div class="media">
                                        <a href="#" class="bn-link">
                                            <figure><img src="assets/images/home-03/bn_special_org2.jpg" width="616" height="483" alt=""></figure>
                                        </a>
                                    </div>
                                    <div class="text-content">
                                        <b class="first-line">Pomegranate</b>
                        ...
                        <ul class="services-list">
                            <li>
                                <div class="service-inner color-reverse">
                                    ...
                                    <span class="biolife-icon icon-onions"></span>
                                    <a class="srv-name" href="#">Fresh vegetables from farm gate</a>
                                </div>
                            </li>
                            <li>
                                <div class="service-inner color-reverse">
                                    ...
                                    <a class="srv-name" href="#">Right away from harvest</a>
                                </div>
                            </li>
                            <li>
                                <div class="service-inner color-reverse">
                                    ...
                                    <a class="srv-name" href="#">Delivery on time</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="banner-contain">
                        ...
                        <div class="text-content">
                            <div class="container text-wrap">
                                ...
                                <div class="product-detail">
                                    <p class="txt-price"><span>Only:</span>Rs. 8.00</p>
                                    <a href="#" class="btn add-to-cart-btn">add to cart</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product deal-layout contain-product__deal-layout">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="slide-down-box">
                                                    <p class="message">All crops are carefully selected to ensure food safety.</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn">add to cart</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
            ...
            <div class="container">
                                ...
                                <ul class="contact-lines">
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">75/63 Cambridge Terrace, Cinnamon gardens, Colombo 07, Sri Lanka </b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-phone"></i>
                                            <b class="desc">Phone: (+94) 778 234 789  (+94) 777 222 888</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-letter"></i>
                                            <b class="desc">Email:  contact@bhawaboga.com</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                       <div class="copy-right-text"><p><a href="www.bhawaboga.com">Bhawa Boga</a></p></div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12">
